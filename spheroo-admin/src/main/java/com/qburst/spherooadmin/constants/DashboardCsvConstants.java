...
public final class DashboardCsvConstants {
    ...
    public static final String CONTENT_DEPOSITION_HEADER_VALUE="attachment; filename=data.csv";
    public static final String CONTENT_TYPE="text/csv";
    public static final String SORT_COLUMN="deliveryToDate";
