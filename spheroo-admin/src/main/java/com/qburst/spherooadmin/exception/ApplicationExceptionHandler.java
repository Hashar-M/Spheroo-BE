...
import com.qburst.spherooadmin.exception.EntityNotFoundException;
import com.qburst.spherooadmin.exception.ErrorResponse;
...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBadCredentialsException(BadCredentialsException ex) {
        ErrorResponse error = new ErrorResponse(Arrays.asList("Invalid email or password."));
